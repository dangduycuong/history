...
class DynastyViewController: BaseViewController {
    ...
    private var viewModel = DynastyViewModel()
    ...
    override func addDataButtonClicked(sender: UIButton) {
        let vc = AddDynastyViewController()
...
extension DynastyViewController: UITableViewDelegate, UITableViewDataSource {
...
extension DynastyViewController: UITextFieldDelegate {
